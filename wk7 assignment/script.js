document.addEventListener('DOMContentLoaded', () => {
    // Load heroes from localStorage or use defaults
    ...
    function animateAttack(element) {
        if (!userPrefs.animationsEnabled) return;
    ...
    attackBtn.addEventListener('click', () => {
        ...
        animateAttack(document.getElementById('battleZone'));
    ...
    heroForm.addEventListener('submit', (e) => {
        ...
        if (heroForm.checkValidity()) {
            ...
            heroForm.reset();
            saveHeroes(); // Save to localStorage after adding new hero
        }
    });
